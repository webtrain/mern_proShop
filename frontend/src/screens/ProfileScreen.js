...
const ProfileScreen = ({ history }) => {
  ...
  const { loading: loadingOrders, error: errorOrders, errorMsg: errorMsgOrders, orderListMy } = orders;
    ...
    <Row>
      ...
      <Col md={9}>
        ...
        {loadingOrders ? (
          ...
          <Message variant="danger">{errorMsgOrders}</Message>
        ) : (
